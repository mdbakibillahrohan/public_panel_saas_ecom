<template>
  <section class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
      <h2 class="text-[#111318] dark:text-white text-2xl font-bold">New Arrivals</h2>
      <div class="flex gap-2">
        <button
          @click="scrollLeft"
          class="size-8 rounded-full border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-50"
        ...
        <button
          @click="scrollRight"
          class="size-8 rounded-full border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
        >
...
const newArrivals = computed(() => productsStore.newArrivals.slice(0, 4))
